...
var loadData = function(loc) {
  ...
  Papa.parse('https://raw.githubusercontent.com/armyputera/webmap_kphbagansiapiapi/main/data/Format_Web_Map_BSA.csv', {
    header: true,
    download: true,
...
// styling, and event listener to layer_BatasKawasan
 var layer_BatasKawasan;
  ...
  layer_BatasKawasan = L.geoJson(json_Batas_Kawasan_KPH_BSA,{
    attribution: '',
    interactive: true,
    dataVar: 'json_Batas_Kawasan_KPH_BSA',
    layerName: 'layer_Batas_Kawasan_KPH_BSA',
  ...
  map.attributionControl.setPrefix('Download <a href="'
    ...
    view <a href="https://github.com/armyputera/webmap_kphbagansiapiapi" target="_blank">code on\
